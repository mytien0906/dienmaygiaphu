<div class="boxfooter_container">
    <div class="fixwidth">
            ...
            <div class="col-md-3">
                ...
                <div class="icon-block">
                    <ul>
                        ...
                        <li>
                            <a id="chatzalo" href="<?= preg_replace('/[^0-9]/', '', $optsetting['hotline']); ?>" title="title">
                                <svg xmlns="http://www.w3.org/2000/svg" class="ionicon s-ion-icon" viewBox="0 0 512 512">
                        ...
                        <li>
                            <a id="tiktok" href="<?= $optsetting['tiktok'] ?>" title="title">
                                <svg xmlns="http://www.w3.org/2000/svg" class="ionicon s-ion-icon" viewBox="0 0 512 512">
       ...
       <div class="copyright">
           <p>
                <span>Địa chỉ: <?= $optsetting['diachi'] ?></span>
                <span>Tổng đài hỗ trợ: <?= $optsetting['dienthoai'] ?></span>
                <span> - Email: <?= $optsetting['email'] ?></span>

           </p>
           <p>© 2019 - Bản quyền thuộc về GIA PHÚ. Design by SotaGroup Co.,Ltd</p>
       </div>
    </div>
</div>