            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <?php if (isset($config['product'][$type]['check_banchay'])) {
                            foreach ($config['product'][$type]['check_banchay'] as $key => $value) { ?>
                                <th class="align-middle text-center"><?= $value ?></th>
                        <?php }
                        } ?>
                        <?php if (isset($config['product'][$type]['check_xemnhieu'])) {
                            foreach ($config['product'][$type]['check_xemnhieu'] as $key => $value) { ?>
                                <th class="align-middle text-center"><?= $value ?></th>
                        <?php }
                        } ?>
                        <?php if (isset($config['product'][$type]['check_hot'])) {
                            foreach ($config['product'][$type]['check_hot'] as $key => $value) { ?>
                                <th class="align-middle text-center"><?= $value ?></th>
                        <?php }
                        } ?>
                        <?php if (isset($config['product'][$type]['check_khuyenmai'])) {
                            foreach ($config['product'][$type]['check_khuyenmai'] as $key => $value) { ?>
                                <th class="align-middle text-center"><?= $value ?></th>
                        <?php }
                        } ?>
