		...
		<div class="card card-primary card-outline text-sm">
			...
			<div class="card-body">
				...
				<div class="row">
					...
					<?php if (isset($config['setting']['giolam']) && $config['setting']['giolam'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="giolam">Giờ làm:</label>
							<input type="text" class="form-control" name="data[options][giolam]" id="giolam" placeholder="Giờ làm" value="<?= $options['giolam'] ?>">
						</div>
					<?php } ?>
				...
				<!-- <?php if (isset($config['setting']['fanpage']) && $config['setting']['fanpage'] == true) { ?>
					<div class="form-group">
						...
						<textarea class="form-control" name="data[options][fanpage]" id="fanpage" rows="5" placeholder="Fanpage"><?= htmlspecialchars_decode($options['fanpage']) ?></textarea>
					</div>
				<?php } ?> -->
